...
![First Load](src/assets/screenshots/first-load-animation.png)
![Login Page](src/assets/screenshots/login-page.png)
![Dashboard](src/assets/screenshots/dashboard.png)

![Large Screen View](src/assets/screenshots/channel-big-screen.png)
![Edit Message](src/assets/screenshots/channel-message-edit.png)
![New Message](src/assets/screenshots/new-message.png)

![Responsive Navbar](src/assets/screenshots/navbar-mobile-view.png)
![Responsive Message](src/assets/screenshots/message-mobile-view.png)
